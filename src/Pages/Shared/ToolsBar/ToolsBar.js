    ...
    return (
        <div className='bg-[#f9f9f9f0] backdrop-blur-[10px] py-[8px] border-t  border-[#0000004d] lg:hidden'>
            <div className='flex justify-center items-center'>
                <div className='flex justify-between items-center w-[331px] h-[44] rounded-[12px] bg-[#00000014] p-[15px]'>
            ...
            <div className='mt-[16px] pb-[31px] flex justify-around items-center'>
